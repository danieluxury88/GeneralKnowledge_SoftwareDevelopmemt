class Burger:
    ...
    def print(self):
        print(f"Buns: {self.buns} Patty: {self.patty} Cheese: {self.cheese}")
...
burger = BurgerBuilder().add_buns("sesame").add_patty("fish-patty").add_cheese("swiss cheese").build().print()
